...
func generateTestColors() []testColor {
	...
	colors = append(colors,
		testColor{"Black", color.RGBA{0, 0, 0, 0}, HSVColor{0, 0, 0}},
		testColor{"White", color.RGBA{255, 255, 255, 0}, HSVColor{0, 0, 100}},
		testColor{"Red", color.RGBA{255, 0, 0, 0}, HSVColor{0, 100, 100}},
		testColor{"Lime", color.RGBA{0, 255, 0, 0}, HSVColor{120, 100, 100}},
		testColor{"Blue", color.RGBA{0, 0, 255, 0}, HSVColor{240, 100, 100}},
		testColor{"Yellow", color.RGBA{255, 255, 0, 0}, HSVColor{60, 100, 100}},
		testColor{"Cyan", color.RGBA{0, 255, 255, 0}, HSVColor{180, 100, 100}},
		testColor{"Magenta", color.RGBA{255, 0, 255, 0}, HSVColor{300, 100, 100}},
		testColor{"Silver", color.RGBA{192, 192, 192, 0}, HSVColor{0, 0, 75}},
		testColor{"Gray", color.RGBA{128, 128, 128, 0}, HSVColor{0, 0, 50}},
		testColor{"Maroon", color.RGBA{128, 0, 0, 0}, HSVColor{0, 100, 50}},
		testColor{"Olive", color.RGBA{128, 128, 0, 0}, HSVColor{60, 100, 50}},
		testColor{"Green", color.RGBA{0, 128, 0, 0}, HSVColor{120, 100, 50}},
		testColor{"Purple", color.RGBA{128, 0, 128, 0}, HSVColor{300, 100, 50}},
		testColor{"Teal", color.RGBA{0, 128, 128, 0}, HSVColor{180, 100, 50}},
		testColor{"Navy", color.RGBA{0, 0, 128, 0}, HSVColor{240, 100, 50}},
	)
